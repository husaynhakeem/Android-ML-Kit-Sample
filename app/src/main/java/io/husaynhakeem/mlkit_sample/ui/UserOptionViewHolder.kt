...
import kotlinx.android.synthetic.main.layout_user_option.view.*

class UserOptionViewHolder(private val listener: Listener, parent: ViewGroup) :
        RecyclerView.ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_user_option, parent, false)) {
